...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        Activity.objects.create(user=users[2], type='Swimming', duration=60, date='2025-11-03')
        Activity.objects.create(user=users[3], type='Running', duration=25, date='2025-11-01')
        Activity.objects.create(user=users[4], type='Cycling', duration=35, date='2025-11-02')
        Activity.objects.create(user=users[5], type='Swimming', duration=50, date='2025-11-03')
